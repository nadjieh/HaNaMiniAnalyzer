...
if __name__ == "__main__":
    ...
    #limitsMMBB2016 = LimitReader( "../../macro/combine/Unblinding/Limits.root" , ROOT.kAzure-7 )
    limitsMMBB2016 = LimitReader( "../../macro/combine/Unblinding/MMTTIncluded/limits%d.root" % args.model , ROOT.kAzure-7 , is2d = True)
    ...
    canvas.SaveAs('plots/run2_plot_BRaa_Type'+str(args.model)+postfix+'_mmtt_observed.pdf')
